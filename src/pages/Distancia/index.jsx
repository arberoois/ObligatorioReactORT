...
const Index = () => {
    ...
    const handleDistancia = async (e) => {
        ...
        if (
            distancia.idCiudadOrigen === "X" ||
            distancia.idCiudadDestino === "Y"
        ) {
            toast.error("Todos los campos son obligatorios");
            return;
        }
        const distanciaCalculada = getDistance({ latitude: cO.latitud, longitude: cO.longitud },
            { latitude: cD.latitud, longitude: cD.longitud }
        ) / 100;
        console.log(distanciaCalculada)
        toast.success("La distancia entre las ciudades seleccionadas es de: " + distanciaCalculada + " km")
    };
        ...
        <>
            <div className="create-shipping">
                ...
                <form>
                    ...
                    <button onClick={handleDistancia}>Enviar</button>
                </form>
            </div>
            <Toaster></Toaster>
        </>
